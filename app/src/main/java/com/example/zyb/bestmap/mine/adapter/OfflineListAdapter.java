...
import com.example.zyb.bestmap.mine.util.OfflineChild;
...
public class OfflineListAdapter extends BaseExpandableListAdapter implements OnGroupCollapseListener, OnGroupExpandListener {
    ...
    public OfflineListAdapter(List<OfflineMapProvince> provinceList, HashMap<Object, List<OfflineMapCity>> cityMap, OfflineMapManager amapManager, Context mContext) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (isOpen[groupPosition]) {
            group_image.setImageDrawable(mContext.getResources().getDrawable(R.drawable.downarrow));
        } else {
            group_image.setImageDrawable(mContext.getResources().getDrawable(R.drawable.rightarrow));
        }
        return convertView;
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        //OfflineMapCity mapCity = cityMap.get(groupPosition).get(childPosition);
